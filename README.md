...
Every result (matches or no-match) ends with a **Powered by dsh.so** footer plus a copyright/license line (`dsh-plugin-finder v0.1.7 · © 2026 zhoushimin · Apache-2.0`). Disable with `attribution: false`.
