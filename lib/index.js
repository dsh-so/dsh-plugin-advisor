...
function cardText(matches, gap, covered) {
    const top = matches[0];
        ...
        presentResult(args, result) {
            ...
            if (r.installed !== undefined || r.removed !== undefined) {
                ...
                return {
                    ...
                    content: [{ type: 'text', text: String(r.note || r.error || '') }],
                };
            }
            ...
            return {
                ...
                content: [{ type: 'text', text: cardText(matches, r.capabilityGap, r.alreadyCoveredBy) }],
            };
        },
